	...
	<div class="site-info row grid-x grid-margin-x">
		<div class="cell column">
			<span class="blank-theme-copyright-text">
				<?php
				$theme_uri = 'https://rahicodes.wordpress.com';

				/* translators: 1: Theme name, 2: Theme author. */
				$default        = sprintf( esc_html__( '%1$s by %2$s', 'blank-theme' ), esc_html__( 'Blank Theme', 'blank-theme' ), '<a href="' . esc_url( $theme_uri ) . '" rel="designer">' . esc_html__( 'RahiDroid', 'blank-theme' ) . '</a>' );
			...
			<span class="sep">&nbsp;|&nbsp;</span>
			<a class="blank-theme-author-footer" href="<?php echo esc_url( 'https://rahicodes.wordpress.com/' ); ?>" target="_blank" rel="noopener"><?php esc_html_e( 'Blank Theme', 'blank-theme' ); ?></a>
		</div>
	</div><!-- .site-info -->
</footer><!-- #colophon -->
</div><!-- #page -->
